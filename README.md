...
|                  		         DFP | 120      |
|                  		         AFP | 111      |
| SLOC язык Rust соотнош. 50 SLOC/FP | 5550     |
|                               KLOC | 6        |

**Расчет трудозатрат на разработку "с нуля" методом COCOMO II**

|              Фактор масштаба | Значение  |     |         Множитель трудоёмкости | Значение        |
|-----------------------------:|-----------|     |-------------------------------:|-----------------|
|  опыт аналогичных разработок | 2.48      |     |         квалификация персонала | 1.35            |
|            гибкость процесса | 3.04      |     |           надежность продукта  | 1.77            |
|            разрешение рисков | 1.41      |     |        повторное использование | 1.05            |
|        сработанность команды | 1.10      |     | сложность платформы разработки | 1.23            |
|           зрелость процессов | 4.68      |     |                 опыт персонала | 1.89            |
|                       **SF** | **12.71** |     |      оборудование коммуникаций | 0.98            |
|                        **E** | **1.04**  |     |              сжатие расписания | 1.13            |
                                                 |                         **EM** | **6.46**        |
                                                 |                         **PM** | **122 чел/мес** |
                                                 |                       **TDEV** | **15 мес** 	    |
