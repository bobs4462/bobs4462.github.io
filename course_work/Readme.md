...
A1 - Конфигурировать систему веб-шаблонов (относится к внешней среде, включает первичную
конфигурацию системы веб-шаблонов).

А2 - Разработать веб-шаблон (относится к внешней среде, представляет из себя
